...
config :realtime_chat, RealtimeChatWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "5I7YPylFavrwhF3dbCoGh2mG8SeZbEmeYn660wiGpa2gOvhb7LJb5mcrT81QTRjz",
  watchers: [
...
config :realtime_chat, RealtimeChatWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/realtime_chat_web/router\.ex$"E,
      ~r"lib/realtime_chat_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
